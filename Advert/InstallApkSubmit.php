...
$query = 'INSERT INTO `campaign_table` (`method_type`, `select_list`, `start_date`, `end_date`,`Apk_Location`, `Noti_Description`, `Entry_date`, `campaign_name`, `campaign_type`, `Noti_Heading`, `Noti_Icon`, `Apk_Package`, `Noti_Banner`, `Noti_Type`)
  VALUES (:method_type, :select_list, :start_date, :end_date, :Apk_Location, :Noti_Description, now(), :campaign_name, :campaign_type, :Noti_Heading, :Noti_Icon, :Apk_Package,:Noti_Banner,:Noti_Type)';
